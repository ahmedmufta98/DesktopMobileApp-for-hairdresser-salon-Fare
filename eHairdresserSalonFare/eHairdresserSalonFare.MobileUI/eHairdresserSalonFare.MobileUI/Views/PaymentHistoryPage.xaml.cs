...
namespace eHairdresserSalonFare.MobileUI.Views
{
    ...
    {
        private readonly PaymentHistoryViewModel model = null;
        ...
        {
            var clicked_item = e.Item as Model.Payment;

            await Navigation.PushAsync(new PaymentHistoryDetailsPage(clicked_item));
        }
    }
}